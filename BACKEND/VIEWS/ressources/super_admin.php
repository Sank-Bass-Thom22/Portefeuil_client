...
<head>
    ...
    <title>IMMO- AFRICA/Dashboard-1</title>
	<!-- BOOTSTRAP STYLES-->
				...
				<li style="color:white;background-color:blue;text-align:center;">
					...
					<li>
                        <a href="#"> Compte<span class="fa arrow"></span></a>
                           ...
                           <ul class="nav sm">
                                    <li>
                                        <a href="#"style="color:green;">Administrateur<span class="fa arrow"></span></a>
										 <ul class="nav ">
											<li>
												<a href="#" >Nommer un administrateur</a>
				   ...
				   <li>
				   <a href="#"> Fonction avancée<span class="fa arrow"></span></a>
                       
                            
                           <ul class="nav sm" >
                                    <li>
                                        <a href="#" style="color:green;">Activités<span class="fa arrow"></span></a>
										 <ul class="nav ">
											<li>
